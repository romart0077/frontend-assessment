<template>
  <main>
    ...
    <Transition name="slide-fade">
      <CardSection v-show="show" ref="card" :sections="cardData" />
    </Transition>
  </main>
</template>
...
import { showElementOnScroll } from "@/utils/scroll";
import jsonData from "../data.json";

import BannerSection from "@/components/BannerSection.vue";
import CardSection from "@/components/CardSection.vue";

const cardData = ref(jsonData);

const show = ref(false);
const card = ref(null);

onMounted(() =>
  window.addEventListener("scroll", () => showElementOnScroll(show))
);
</script>
